                        ...
                        <table class="table table-responsive table-hover table-bordered">
                            ...
                            <?php for ($i = 1; $i <= count($arr_cart_p_id); $i++) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $arr_cart_p_current_price[$i]; ?>EGP</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        ?>
                                        <?php echo $row_total_price; ?>EGP
                                    </td>
                                </tr>
                            <?php endfor; ?>
                            <tr>
                                <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                                <th class="total-amount"><?php echo $table_total_price; ?>EGP</th>
                            </tr>
                            <?php
                            ...
                            <tr>
                                ...
                                <td class="total-amount"><?php echo $shipping_cost; ?>EGP</td>
                            </tr>
                            <tr>
