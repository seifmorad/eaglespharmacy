...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_page SET about_title=?,about_content=?,about_meta_title=? WHERE id=1");
            $statement->execute(array($_POST['about_title'],$_POST['about_content'],$_POST['about_meta_title']));
        }
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_page SET faq_title=?,faq_meta_title=? WHERE id=1");
            $statement->execute(array($_POST['faq_title'],$_POST['faq_meta_title']));
        }
...
if(isset($_POST['form_contact'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_page SET contact_title=?,contact_meta_title=? WHERE id=1");
            $statement->execute(array($_POST['contact_title'],$_POST['contact_meta_title']));
        }
